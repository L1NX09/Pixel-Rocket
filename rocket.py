    ...
    while True:
        ...
        if game_active and not is_dead:
            ...
            if is_dead:
                ...
                next_state = end_menu(font, win, score_font, score, BLACK, screen_height, screen_width, home_button_img, retry_button_img, line_img, is_mouse_clicked, fade_counter)
                if next_state == 'home':
                    print('home go go')
                    is_dead = False
                    break

                elif next_state == 'retry':
                    print('try again')
                    is_dead = False
                    game_active = True
